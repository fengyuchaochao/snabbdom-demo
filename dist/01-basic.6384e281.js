...
;
},{"./vnode.js":"node_modules/snabbdom/build/package/vnode.js","./is.js":"node_modules/snabbdom/build/package/is.js"}],"src/01-basic.js":[function(require,module,exports) {
"use strict";
...
var patch = (0, _init.init)([_class.classModule, _style.styleModule, _eventlisteners.eventListenersModule]);
var data = [{
  rank: 7,
  title: 'the good',
...
var vnodeTitle = (0, _h.h)('h1', 'Top 10 movies');

function createVnodeSort() {
  var vnodeSort = (0, _h.h)('div.sort-box', [(0, _h.h)('label', 'sort By：'), (0, _h.h)('ul', sortTypeList.map(function (item) {
    return (0, _h.h)('li', {
      on: {
...
function createVnodeList(data) {
  var vnodeList = (0, _h.h)("ul.list.".concat(Date.now()), data.map(function (item, index) {
    return (0, _h.h)('li.list-item', [(0, _h.h)('span', item.rank), (0, _h.h)('h3', item.title), (0, _h.h)('p', item.desc), (0, _h.h)('i', {
      on: {
        click: function click() {
...
function createVnodeContainer() {
  for (var _len = arguments.length, vnodeList = new Array(_len), _key = 0; _key < _len; _key++) {
    vnodeList[_key] = arguments[_key];
  }
...
var oldVnodeList = createVnodeList(data);
...
},{"snabbdom/build/package/init":"node_modules/snabbdom/build/package/init.js","snabbdom/build/package/modules/class":"node_modules/snabbdom/build/package/modules/class.js","snabbdom/build/package/modules/style":"node_modules/snabbdom/build/package/modules/style.js","snabbdom/build/package/modules/eventlisteners":"node_modules/snabbdom/build/package/modules/eventlisteners.js","snabbdom/build/package/h":"node_modules/snabbdom/build/package/h.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
